...
train_data, test_data = TabularDataset.splits(path='.', train='악플맞춤법_train.csv', test='악플맞춤법_test.csv', format='csv', fields=[('text', TEXT), ('label', LABEL)], skip_header=True)
...
predict_sentiment(model, "ㅂ ㅕ ㅇ ㅅ ㅣ ㄴ")